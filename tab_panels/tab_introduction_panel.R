...
tab_introduction_panel <- tabPanel(
  ...
  tags$ul(id = "list1",
    tags$li(strong("Tab `------`:"), "T------"),
    br(),
    tags$li(strong("Tab `Mental Health in Workplace`:"), "This tab
            allows users to visualize whether employees received mental health 
            resources from their company. Users can select a specific mental disorder
            type to view the survey responses on whether they have access to help. Our data 
            visualization answers the question: “how many employees received 
            resources and support from their employers, based on people who have
            been diagnosed with different types of mental illness?” People who 
            completed the survey responded “yes”, “no”, or “I don’t know” to the
            survey question: “does your employer provide resources to learn more 
